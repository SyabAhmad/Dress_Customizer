    ...
    <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 bg-white dark:bg-zinc-900 shadow-sm">
      ...
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="mt-2 w-full rounded-lg border border-zinc-300 dark:border-zinc-700 bg-transparent px-3 py-2"
          >
      ...
      <div className="mt-4 flex gap-2">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-zinc-200 dark:border-zinc-800 px-3 py-2 hover:bg-zinc-50 dark:hover:bg-zinc-800"
        >
